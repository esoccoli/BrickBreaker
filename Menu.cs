...
namespace BrickBreaker
{
    ...
    public class Menu : State
    {
        ...
        public void DrawText()
        {
            ...
            SB.DrawString(NotoSansCabinet, "Press ", new Vector2(Window.Center.X - 300, Window.Center.Y), Color.White);
            SB.Draw(RedButton, new Rectangle(Window.Center.X - 100, Window.Center.Y, 100, 100), Color.White);
            SB.DrawString(NotoSansCabinet, " to Start", new Vector2(Window.Center.X + 100 , Window.Center.Y), Color.White);
            
            SB.DrawString(NotoSansCabinet, "Press ", new Vector2(Window.Center.X - 400, Window.Center.Y + 150), Color.White);
            SB.Draw(BlueButton, new Rectangle(Window.Center.X - 275, Window.Center.Y + 150, 100, 100), Color.White);
            SB.DrawString(NotoSansCabinet, " for Instructions", new Vector2(Window.Center.X - 125, Window.Center.Y + 150), Color.White);
